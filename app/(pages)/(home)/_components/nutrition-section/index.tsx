...
import { nutrientListData } from "@/app/utils/constants"
...
export const NutritionSection = () => {
  ...
  const [nutrientList, setNutrientList] = useState(nutrientListData)

  useEffect(() => {
    if (isMobile) {
      setNutrientList(nutrientListData.slice(0, 3))
    } else {
      setNutrientList(nutrientListData)
    }
  }, [isMobile])
